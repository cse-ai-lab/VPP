...
def run_eval(pred_dir, gt_dir, sd=None):
    ...
    test_files = open('/home/csgrad/sahmed9/reps/chartinfo-cqa/dataset/cqa_22_with_id/test_filenames.txt', 'r').readlines()
    ...
    for cix, chart in tqdm.tqdm(enumerate(chart_files)) :
        ...
        for gt in gt_js :
            gt_id = gt['qa_id']
            gt_ans = gt['answer']
            # pr_obj[gt_id]["predicted_answer"] = pr_obj[gt_id]["answer"]    ## never uncomment this 
    ...
    gtVbox  = len([_ for _ in cobj['vertical box'] if _ in score_obj['string_score']]) +\
            len([_ for _ in cobj['vertical box'] if _ in score_obj['num_score']]) +\
            len([_ for _ in cobj['vertical box'] if _ in score_obj['rank_score']]) + \
            len([_ for _ in cobj['vertical box'] if _ in score_obj['urank_score']]) +\
            len([_ for _ in cobj['vertical box'] if _ in score_obj['bi_score']]) 
    ...
    print('Total Evaluated qa pairs ', round(totalpred), '/', totalgt)
    print('Total Accuracy ', totalpred/totalgt)
    print('-'*10)
    print('Total Evaluated String qa pairs ',predstring, '/', gtstring )
    print('String Acc ', predstring/gtstring )
    print('-'*10)
    print('Total Evaluated Numeric qa pairs ', prednum, '/',  gtnum)
    print('Numeric Acc ', prednum/gtnum )
    print('-'*10)
    print('Total Evaluated Ranked qa pairs ', round(predrank), '/', gtrank)
    print('Rank Acc ', predrank/gtrank )
    print('-'*10)
    print('Total Evaluated Unranked qa pairs ', round(predurank), '/', gturank)
    print('Urank Acc ', predurank/gturank )
    print('-'*10)
    print('Total Evaluated Binary qa pairs ', predbi, '/', gtbi)
    ...
    print('-'*30)
    print('Total Evaluated Structure qa pairs ', predStruct, '/',  gtStruct)
    print('Struc Acc ', predStruct/gtStruct )
    print('-'*10)
    print('Total Evaluated Ret qa pairs ',  predRet, '/', gtRet)
    print('Retreival Acc ', predRet/gtRet )
    print('-'*10)
    print('Total Evaluated Res qa pairs ',  predRes, '/', gtRes)
    print('Reason Acc ', predRes/gtRes )

    
    print('-'*30)
    print('Total Evaluated Line qa pairs ',predLine, '/', gtLine)
    print('Line Acc ', predLine/gtLine )
    
    print('-'*10)
    print('Total Evaluated VBar qa pairs ', predVbar, '/',gtVbar)
    print('Vbar Acc ', predVbar/gtVbar )
    
    print('-'*10)
    print('Total Evaluated Hbar qa pairs ', predHbar, '/',gtHbar)
    print('Hbar Acc ', predHbar/gtHbar )
    
    print('-'*10)
    print('Total Evaluated Scatter qa pairs ', predScat, '/',gtScat)
    print('Sca Acc ', predScat/gtScat )
    
    print('-'*10)
    print('Total Evaluated VBox qa pairs ',predVbox , '/',gtVbox)
...
if __name__ == "__main__": 
    ...
    pred_dir = '/home/csgrad/sahmed9/reps/RealCQA/output_matcha_plotqav1'
    # pred_dir = '/home/csgrad/sahmed9/reps/RealCQA/code/eval_result/checkpoint_epoch_7_step_142000'
    pred_dir = '/home/csgrad/sahmed9/reps/RealCQA/code/eval_result/checkpoint_epoch_7_step_148000'
    # pred_dir = '/home/csgrad/sahmed9/reps/RealCQA/code/eval_result/checkpoint_epoch_7_step_150000'
